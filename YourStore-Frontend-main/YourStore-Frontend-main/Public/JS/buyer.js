$(document).ready(function () {
    ...
    function getShop() {
        ...
        const getShop_api = `http://localhost:3000/shop/${shopID}`;
    ...
    $("body").on("click", ".add-to-cart", function (e) {
        ...
        if (!localStorage.getItem("authToken")) {
            ...
            const quantity = $(this)
                ...
                .val();
            const add_to_cart_api = `http://localhost:3000/user/addCart/${itemID}/${quantity}`;
    ...
    $("#search-input-btn").on("click", function (e) {
        ...
        const search_api = `http://localhost:3000/searchItem/${sessionStorage.getItem(
            "shopID"
        )}?search=${searchQuery}`;
