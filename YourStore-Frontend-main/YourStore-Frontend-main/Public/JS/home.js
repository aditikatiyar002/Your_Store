$(document).ready(function () {
    ...
    $(".request-button").on("click", function (e) {
        ...
        const request_api = "http://localhost:3000/user/requestItem";
    ...
    function getShopsAround(latitude, longitude) {
        showLoader($(".overlay"));
        let shops_around_api = `http://localhost:3000/shops-within/10/center/${latitude}, ${longitude}/`;
    ...
    function searchShops(searchQuery) {
        const search_api = `http://localhost:3000/searchShops?search=${searchQuery}`;
    ...
    function getTrendingItems() {
        const trending_api = `http://localhost:3000/trending`;
