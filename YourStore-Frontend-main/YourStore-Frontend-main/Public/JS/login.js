$(document).ready(function () {
    ...
    const signup_url = "http://localhost:3000/user/signup";
    const shop_signup_url = "http://localhost:3000/store/register";
    const shop_signin_url = "http://localhost:3000/store/login";
