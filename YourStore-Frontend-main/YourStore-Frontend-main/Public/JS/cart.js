$(document).ready(function () {
    ...
    $(".add-new-address-btn").on("click", function (e) {
        ...
        const add_adress_api = `http://localhost:3000/user/me/addAddress`;
    ...
    //--------------------GET PROFILE-------------------------
    function getProfile() {
        const profile_api = "http://localhost:3000/user/me";
    ...
    function getAddresses() {
        const address_api = "http://localhost:3000/user/me";
    ...
    function getCart() {
        if (sessionStorage.getItem("shopInCart") == "undefined") {
            ...
            const get_shop_api = `http://localhost:3000/shop/${sessionStorage.getItem(
                "shopInCart"
            )}`;
    ...
    function getCartItems() {
        ...
        const cart_api = `http://localhost:3000/user/Cart`;
    ...
    $("body").on("click", ".increase-quantity", function (e) {
        ...
        const increase_api = `http://localhost:3000/user/cart/increase/${itemID}/1`;
    ...
    $("body").on("click", ".decrease-quantity", function (e) {
        ...
        const decrease_api = `http://localhost:3000/user/cart/increase/${itemID}/-1`;
    ...
    $(".confirm").on("click", function (e) {
        ...
        const checkout_api = `http://localhost:3000/user/checkout`;
