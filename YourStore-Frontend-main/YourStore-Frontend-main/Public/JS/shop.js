...
$(document).ready(function () {
    ...
    const get_profile_url = "http://localhost:3000/stores/myStore";

    function getShop() {
        let myHeaders = new Headers();
        myHeaders.append(
            "Authorization",
            `Bearer ${localStorage.getItem("shopAuth")}`
        );
    ...
    $(".overlay").on("click", function () {
        ...
        $(this)
            .parent("body")
            .children(".add-products-container")
            .addClass("hidden");
    ...
    const add_products_api = "http://localhost:3000/myStore/addItem";
    ...
    const get_products = "http://localhost:3000/myProducts";
    ...
    function getRequests() {
        const get_requests_api = "http://localhost:3000/store/requested";
    ...
    function getOrders() {
        const get_orders_api = "http://localhost:3000/store/Orders";
    ...
    function getOrderHistory() {
        const get_orders_api = "http://localhost:3000/store/OrderHistory";
    ...
    function createAllCard(result) {
        if (result.length == 0) {
            $(".all-container").empty();
            $(".all-container").html(
                "<div class='no-products-text'>No products yet!</div>"
            );
        } else {
            let img = "";
            let output = ``;
            ...
            for (i = 0; i < result.length; i++) {
                ...
                let unit = "unit/s";
                if (
                    result[i].tags == "fruits" ||
                    result[i].tags == "vegetables"
                ) {
                    unit = "Kg";
                }
                output += `
    ...
    function createRequestCard(result) {
        if (result.data.length == 0) {
            ...
            $(".requests-container").html(
                "<div class='no-products-text'>No Requests </div>"
            );
        } else {
            let output = ``;
    ...
    $("body").on("click", ".deliver-btn", function (e) {
        ...
        $(".confirm-delivery").on("click", function (e) {
            ...
            let delivery_api = `http://localhost:3000/store/delivered/${userID}/${orderID}`;

            let myHeaders = new Headers();
            myHeaders.append(
                "Authorization",
                `${localStorage.getItem("shopAuth")}`
            );
    ...
    $(".products").on("click", ".delete-item-btn", function (e) {
        ...
        const id = $(this)
            ...
            .children("#item-id")
            .text();
        const delete_item_url = `http://localhost:3000/myProducts/delete/${id}`;
                ...
                fetch(delete_item_url, requestOptions)
                    ...
                    .then((result) => {
                        ...
                        if (
                            $(this)
                                .parents(".products")
                                .children(".all-container").length > 0
                        ) {
                            getProducts().then((result) => {
                                createAllCard(result);
                            });
                            ...
                            $(this)
                                .parents(".products")
                                .children(".fruits-veggies-container").length >
                            0
                        ) {
                            getProducts().then((result) => {
                                createFruitsAndVegCard(result);
                            ...
                            $(this)
                                .parents(".products")
                                .children(".meat-container").length > 0
                        ) {
                            getProducts().then((result) => {
                                createTaggedCard(
                                    result,
                            ...
                            $(this)
                                .parents(".products")
                                .children(".dairy-container").length > 0
                        ) {
                            getProducts().then((result) => {
                                createTaggedCard(
                                    result,
                            ...
                            $(this)
                                .parents(".products")
                                .children(".snacks-container").length > 0
                        ) {
                            getProducts().then((result) => {
                                createTaggedCard(
                                    result,
                            ...
                            $(this)
                                .parents(".products")
                                .children(".drinks-container").length > 0
                        ) {
                            getProducts().then((result) => {
                                createTaggedCard(
                                    result,
    ...
    $("body").on("click", ".delete-request", function (e) {
        ...
        $(".confirm-request-delete").on("click", function (e) {
            ...
            const delete_request_api = `http://localhost:3000/requests/remove/${requestID}`;
            let myHeaders = new Headers();
            myHeaders.append(
                "Authorization",
                `Bearer ${localStorage.getItem("shopAuth")}`
    ...
    $(".logout").on("click", function (e) {
        ...
        const logout_api = "http://localhost:3000/store/logout";
